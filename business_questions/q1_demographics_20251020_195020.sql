    ...
    -- Q1: Demographics for top/bottom 13 LGAs
    WITH lga_revenue AS (
        SELECT 
            dl.lga_code,
            dl.lga_name,
    ...
    SELECT 
        ...
        pc.lga_name,
        pc.avg_revenue_per_listing,
        g01.median_age_persons,
        g02.average_household_size,
        g02.median_household_income_weekly,
        g02.median_rent_weekly
    FROM performance_categories pc
    LEFT JOIN public_bronze.bronze_census_g01 g01 ON pc.lga_code = g01.lga_code
    LEFT JOIN public_bronze.bronze_census_g02 g02 ON pc.lga_code = g02.lga_code
    ORDER BY pc.avg_revenue_per_listing DESC;
