...
with fact_with_dimensions as (
    select
        ...
        f.host_id,
        -- Get property characteristics from Silver data
        s.property_type_clean as property_type,
        s.room_type_clean as room_type,
        s.accommodates
...
monthly_metrics as (
    ...
    group by property_type, room_type, accommodates, scraped_year, scraped_month
),
...
order by property_type, room_type, accommodates, scraped_year, scraped_month
